...
namespace sapHowmuch.Base.Management
{
	public static class UacHelper
	{
		...
		public static bool IsUacEnabled
		{
			get
			{
				RegistryKey uacKey = Registry.LocalMachine.OpenSubKey(_uacRegistryKey, false);
			...
			get
			{
				if (IsUacEnabled)
				{
					...
					if (success)
					{
						...
						bool isPrcessAdmin = elevationResult == TOKEN_ELEVATION_TYPE.TokenElevationTypeFull;

						return isPrcessAdmin;
					}
					else
					{
		...
		public static bool IsElevatedOf(Process process)
		{
			if (IsUacEnabled)
			{
				IntPtr tokenHandle;
